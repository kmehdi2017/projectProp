...
```{r}
vars <- c("HC01_VC03","HC01_VC04","HC01_VC06" , "HC01_VC08",  "HC01_VC10",  "HC01_VC12",  "HC01_VC13", 
"HC01_VC21",  "HC01_VC22",  "HC01_VC76",  "HC01_VC85",  "HC01_VC88",  "HC01_VC89",  "HC01_VC90", 
"HC01_VC91",  "HC01_VC92",  "HC01_VC95",  "HC01_VC96",  "HC01_VC136", "HC01_VC140", "HC01_VC141")

familyEduDS <- originDS[-1,vars]

columnNames <- c("tot_hh","fam_hh","married_couple" , "husband_only",  "wife_only",  "non_fam_hh",  "non_fam_alone", "avg_hh_size",  "avg_fam_size",  "sch_enrollment",  "edu_attainment",  "high_sch_grad",  "some college",  "associate_deg", "bachelor_deg",  "graduate_prof",  "percent_highsch",  "percent_bachelor",  "tot_foreign_born", "citizen_foreign", "natur_citizen")
...
some statistics:
```{r}
describe(as.numeric(familyEduDS$married_couple))
```
